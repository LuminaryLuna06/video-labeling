...
export class KnowledgeBaseComponent implements OnInit {
  ...
  openEditDialog(node: KBNode): void {
    ...
    this.nodeForm = {
      ...
      description_graph: node.description_graph || '',
      description_graph_vi: node.description_graph_vi || '',
  ...
  saveNode(): void {
    ...
    const data: any = {
      ...
      description_graph: this.nodeForm.description_graph,
      description_graph_vi: this.nodeForm.description_graph_vi,
